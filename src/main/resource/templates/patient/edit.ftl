...
<form method="post" action="patient/save.do" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
	...
	<div class="pageContent">
		<div class="pageFormContent" layoutH="56">
			...
			<dl>
				<dt>吸烟史：</dt>
				<dd><input class="required" name="smoker" type="text" size="30" value="${(model.smoker)!}"/></dd>
			</dl>
			<dl>
				<dt>身份证：</dt>
				<dd><input class="required" name="nationalId" type="text" size="30" value="${(model.nationalId)!}"/></dd>
			</dl>
			<dl>
				<dt>电话：</dt>

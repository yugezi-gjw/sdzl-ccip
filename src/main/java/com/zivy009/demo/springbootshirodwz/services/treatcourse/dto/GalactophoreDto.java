...
public class GalactophoreDto extends AbstractBodypartDto {
  ...
  public static GalactophoreDto fromEntity(TreatCourseGalactophore entity) {
    ...
    dto.setBackup1(entity.getBackup1());
    dto.setBackup2(entity.getBackup2());
    dto.setBackup3(entity.getBackup3());
    dto.setBackup4(entity.getBackup4());
    dto.setBackup5(entity.getBackup5());
    dto.setBackup6(entity.getBackup6());
    dto.setBackup7(entity.getBackup7());
    dto.setBackup8(entity.getBackup8());
    dto.setBackup9(entity.getBackup9());
    dto.setBackup10(entity.getBackup10());
  ...
  public TreatCourseGalactophore toEntity() {
    ...
    entity.setBackup1(backup1);
    entity.setBackup2(backup2);
    entity.setBackup3(backup3);
    entity.setBackup4(backup4);
    entity.setBackup5(backup5);
    entity.setBackup6(backup6);
    entity.setBackup7(backup7);
    entity.setBackup8(backup8);
    entity.setBackup9(backup9);
    entity.setBackup10(backup10);
